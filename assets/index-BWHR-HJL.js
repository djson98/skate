...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ts(e,t,n){let r=new Float32Array(ds),i=new V(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Os(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <div style="display:flex;justify-content:space-between;align-items:baseline;padding:9px 0;border-top:1px solid rgba(15,23,42,0.06);">
        <div style="display:flex;align-items:baseline;gap:8px;min-width:0;">
          <span style="font-size:14px;font-weight:600;color:#0f172a;letter-spacing:0.005em;white-space:nowrap;">${e}</span>
          ${t.count>1?`<span style="font-size:10.5px;color:#64748b;font-weight:700;background:rgba(15,23,42,0.06);padding:2px 7px;border-radius:999px;letter-spacing:0.02em;">×${t.count}</span>`:``}
        </div>
        <span style="font-size:14px;font-weight:600;color:#0f172a;font-variant-numeric:tabular-nums;font-feature-settings:'tnum';letter-spacing:-0.01em;">+${t.total.toLocaleString()}</span>
      </div>
    `).join(``)}function km(e){let{overlay:t,card:n}=Dm(),r=Om(),i=fm.size>0;n.innerHTML=`<div style="font-size:10.5px;letter-spacing:0.36em;color:#64748b;font-weight:700;text-transform:uppercase;margin-bottom:2px;">Run Complete</div><div style="font-size:104px;line-height:1.05;font-weight:800;letter-spacing:-0.04em;color:#0f172a;font-variant-numeric:tabular-nums;font-feature-settings:'tnum';margin-top:6px;">${e.toLocaleString()}</div><div style="font-size:12px;color:#64748b;font-weight:500;letter-spacing:0.04em;margin-top:2px;">total score${dm>1?`  ·  best combo ×${dm}`:``}</div>`+(i?`<div style="margin-top:24px;padding-top:16px;border-top:1px solid rgba(15,23,42,0.08);text-align:left;"><div style="font-size:9.5px;letter-spacing:0.32em;color:#94a3b8;font-weight:700;text-transform:uppercase;margin-bottom:6px;">Tricks Landed</div>`+r+`</div>`:``)+`<div style="margin-top:24px;display:flex;align-items:center;justify-content:center;gap:8px;font-size:12.5px;color:#64748b;font-weight:500;"><span style="display:inline-flex;align-items:center;justify-content:center;min-width:22px;height:22px;padding:0 7px;border:1px solid rgba(15,23,42,0.18);border-radius:6px;font-weight:700;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;color:#0f172a;background:rgba(255,255,255,0.6);font-size:11.5px;box-shadow:0 1px 0 rgba(15,23,42,0.04);">R</span><span>다시 시작</span></div>`,t.style.background=`rgba(15, 23, 42, 0.06)`,t.style.backdropFilter=`blur(4px) saturate(120%)`,t.style.webkitBackdropFilter=`blur(4px) saturate(120%)`,t.style.opacity=`1`,t.offsetWidth,n.style.transform=`scale(1) translateY(0)`}function Am(){if(!_m)return;let e=_m.querySelector(`[data-finish-card]`);_m.style.opacity=`0`,_m.style.background=`rgba(15, 23, 42, 0)`,_m.style.backdropFilter=`blur(0px)`,_m.style.webkitBackdropFilter=`blur(0px)`,e&&(e.style.transform=`scale(0.92) translateY(12px)`)}function jm(){if(gm)return gm;let e=document.createElement(`div`);return e.style.position=`fixed`,e.style.top=`12px`,e.style.right=`12px`,e.style.fontFamily=`ui-monospace, SFMono-Regular, Menlo, monospace`,e.style.fontWeight=`900`,e.style.color=`#fff`,e.style.textShadow=`0 1px 2px rgba(0,0,0,0.85)`,e.style.textAlign=`right`,e.style.pointerEvents=`none`,e.style.zIndex=`100`,document.body.appendChild(e),gm=e,e}function Mm(){let e=jm(),t=lm>1?`Combo ×${lm}`:`Ready`;e.innerHTML=`<div style="font-size:36px;line-height:1;">${cm}</div><div style="font-size:14px;line-height:1.2;margin-top:4px;opacity:0.9;">${t}</div>`}function Nm(){if(vm&&ym)return{wrap:vm,dot:ym};let e=document.createElement(`div`);e.style.position=`fixed`,e.style.top=`200px`,e.style.left=`50%`,e.style.transform=`translateX(-50%)`,e.style.width=`${bm}px`,e.style.height=`${xm}px`,e.style.opacity=`0`,e.style.pointerEvents=`none`,e.style.zIndex=`99`,e.style.transition=`opacity 0.18s ease-out`,e.style.filter=`drop-shadow(0 4px 12px rgba(0,0,0,0.45))`;let t=`http://www.w3.org/2000/svg`,n=document.createElementNS(t,`svg`);n.setAttribute(`width`,String(bm)),n.setAttribute(`height`,String(xm)),n.setAttribute(`viewBox`,`0 -14 ${bm} ${xm}`),n.style.position=`absolute`,n.style.inset=`0`,n.style.overflow=`visible`;let r=document.createElementNS(t,`defs`),i=document.createElementNS(t,`linearGradient`);i.setAttribute(`id`,`balanceArcGrad`),i.setAttribute(`x1`,`0%`),i.setAttribute(`y1`,`0%`),i.setAttribute(`x2`,`100%`),i.setAttribute(`y2`,`0%`);for(let[e,n]of[[0,`#ff2a2a`],[12.5,`#ff2a2a`],[28,`#ffb84d`],[42,`#4ade80`],[58,`#4ade80`],[72,`#ffb84d`],[87.5,`#ff2a2a`],[100,`#ff2a2a`]]){let r=document.createElementNS(t,`stop`);r.setAttribute(`offset`,`${e}%`),r.setAttribute(`stop-color`,n),i.appendChild(r)}r.appendChild(i),n.appendChild(r);let a=`M 0 ${Cm} A ${Sm} ${Sm} 0 0 1 ${bm} ${Cm}`,o=document.createElementNS(t,`path`);o.setAttribute(`d`,a),o.setAttribute(`fill`,`none`),o.setAttribute(`stroke`,`rgba(0,0,0,0.55)`),o.setAttribute(`stroke-width`,`22`),o.setAttribute(`stroke-linecap`,`round`),n.appendChild(o);let s=document.createElementNS(t,`path`);s.setAttribute(`d`,a),s.setAttribute(`fill`,`none`),s.setAttribute(`stroke`,`url(#balanceArcGrad)`),s.setAttribute(`stroke-width`,`16`),s.setAttribute(`stroke-linecap`,`round`),n.appendChild(s);let c=document.createElementNS(t,`line`);c.setAttribute(`x1`,String(bm/2)),c.setAttribute(`y1`,`-10`),c.setAttribute(`x2`,String(bm/2)),c.setAttribute(`y2`,`10`),c.setAttribute(`stroke`,`rgba(255,255,255,0.9)`),c.setAttribute(`stroke-width`,`2.5`),c.setAttribute(`stroke-linecap`,`round`),n.appendChild(c),e.appendChild(n);let l=document.createElement(`div`);return l.style.position=`absolute`,l.style.width=`26px`,l.style.height=`26px`,l.style.borderRadius=`50%`,l.style.background=`#fff`,l.style.boxShadow=`0 2px 6px rgba(0,0,0,0.4), inset 0 0 0 3px #1a1a1a`,l.style.transform=`translate(-50%, -50%)`,l.style.transition=`left 0.05s linear, top 0.05s linear, background 0.1s linear`,l.style.left=`${bm/2}px`,l.style.top=`0px`,l.style.pointerEvents=`none`,e.appendChild(l),document.body.appendChild(e),vm=e,ym=l,{wrap:e,dot:l}}function Pm(){let{wrap:e}=Nm();e.style.opacity=`1`}function Fm(){vm&&(vm.style.opacity=`0`)}function Im(){if(!vm||!ym||vm.style.opacity===`0`)return;let e=Math.max(-1,Math.min(1,Q.grindBalance)),t=e*wm,n=bm/2+Sm*Math.sin(t),r=Sm-Sm*Math.cos(t);ym.style.left=`${n}px`,ym.style.top=`${r}px`;let i=Math.abs(e),a=Math.round(255-i*200),o=Math.round(255-i*200);ym.style.background=`rgb(255,${a},${o})`}function Lm(){jm(),Mm(),$u(`skate:airstart`,()=>{em=0,tm=Ju.rotation.y,nm=tm,rm=0,im=!1,um=null}),$u(`skate:grindstart`,({rail:e})=>{let t=$p(Ju.rotation.y-tm),n=Math.abs(Math.abs(t)-Math.PI)<om,r=null;n&&em!==0?r=rm===1&&em===1?`VARIAL KICKFLIP`:rm===1&&em===-1?`INWARD HEELFLIP`:rm===-1&&em===1?`HARDFLIP`:`VARIAL HEELFLIP`:n?r=rm===1?`POP SHUVIT`:rm===-1?`FRONT POP`:`SHUVIT`:em===1?r=`KICKFLIP`:em===-1&&(r=`HEELFLIP`);let i=r?`${r} ${e}`:`${e} GRIND`;lm+=1;let a=100+(r?sm[r]??0:0),o=lm===1?1:1+(lm-1)*.2,s=Math.round(a*o);cm+=s,Mm(),Em(i,s,lm),em=0,rm=0}),$u(`skate:landing`,()=>{if(Q.grinding)return;Ju.rotation.z=$p(Ju.rotation.z),Ju.rotation.y=$p(Ju.rotation.y);let e=Ju.rotation.z,t=Ju.rotation.x,n=$p(Ju.rotation.y-tm),r=Math.abs(n),i=r<am||Math.abs(r-Math.PI)<am;if(Math.abs(e)<am&&Math.abs(t)<om&&i){let e,t=Math.abs(r-Math.PI)<am;e=t&&em!==0?rm===1&&em===1?`VARIAL KICKFLIP`:rm===1&&em===-1?`INWARD HEELFLIP`:rm===-1&&em===1?`HARDFLIP`:`VARIAL HEELFLIP`:t?rm===1?`POP SHUVIT`:rm===-1?`FRONT POP`:`SHUVIT`:em===0?`OLLIE`:em===1?`KICKFLIP`:`HEELFLIP`,Qu({type:`skate:trick`,name:e,clean:!0})}else Q.bailing=!0,Qu({type:`skate:bail`});i&&Math.abs(r-Math.PI)<am&&(Ju.rotation.y=0),Q.flipSpeed=0,em=0}),$u(`skate:trick`,({name:e})=>{lm+=1,lm>dm&&(dm=lm);let t=sm[e]??100,n=lm===1?1:1+(lm-1)*.2,r=Math.round(t*n);cm+=r,pm(e,r),Mm(),e===`OLLIE`&&Em(e,r,lm)}),$u(`skate:bail`,()=>{lm=0,Mm(),Fm()}),$u(`skate:reset`,()=>{cm=0,lm=0,dm=0,em=0,rm=0,im=!1,fm.clear(),Mm(),Fm(),Am()}),$u(`skate:grindstart`,({rail:e})=>{Pm(),Em(e)}),$u(`skate:grindend`,({rail:e,distance:t})=>{if(Fm(),t<.5)return;lm+=1,lm>dm&&(dm=lm);let n=Math.round(20+t*60),r=lm===1?1:1+(lm-1)*.2,i=Math.round(n*r);cm+=i;let a=`${e} GRIND`;pm(a,i),Mm(),Em(a,i,lm)}),$u(`skate:finish`,()=>{km(cm)})}function Rm(e){if(Q.airTime>0){let t=1-Q.airTime/Q.currentJumpDuration,n=Math.sin(t*Math.PI)*.25*(1-t*.6);Ju.rotation.x=-n,Q.flipSpeed>0?em=1:Q.flipSpeed<0&&(em=-1),Ju.rotation.z+=Q.flipSpeed*e,im||(Xu.KeyN?(nm=tm-Math.PI,rm=1,im=!0):Xu.KeyM&&(nm=tm+Math.PI,rm=-1,im=!0)),im&&(Ju.rotation.y=Pt.lerp(Ju.rotation.y,nm,Math.min(1,e*8)));let r=null;im&&em!==0?rm===1&&em===1?r=`VARIAL KICKFLIP`:rm===1&&em===-1?r=`INWARD HEELFLIP`:rm===-1&&em===1?r=`HARDFLIP`:rm===-1&&em===-1&&(r=`VARIAL HEELFLIP`):im?rm===1?r=`POP SHUVIT`:rm===-1&&(r=`FRONT POP`):em===1?r=`KICKFLIP`:em===-1&&(r=`HEELFLIP`),r&&r!==um&&(Em(r),um=r)}else{Ju.rotation.x+=(0-Ju.rotation.x)*Math.min(1,e*12);let t=Xu.KeyA||Xu.ArrowLeft,n=Xu.KeyD||Xu.ArrowRight,r=t?.15:n?-.15:0;Ju.rotation.z+=(r-Ju.rotation.z)*Math.min(1,e*8)}Q.grinding&&Im()}var zm,Bm,Vm=null,Hm=null,Um=null,Wm=null,Gm,Km=!1;function qm(){let e=async()=>{zm.state===`suspended`&&await zm.resume(),Km=!0,Hm&&!Wm&&Ym(),window.removeEventListener(`keydown`,e),window.removeEventListener(`pointerdown`,e)};window.addEventListener(`keydown`,e),window.addEventListener(`pointerdown`,e)}async function Jm(e){try{let t=await(await fetch(e)).arrayBuffer();return await zm.decodeAudioData(t)}catch(t){return console.warn(`[sound] failed to load`,e,t),null}}function Ym(){if(!Hm)return;let e=zm.createBufferSource();e.buffer=Hm,e.loop=!0,Gm=zm.createGain(),Gm.gain.value=0,e.connect(Gm).connect(Bm),e.start(),Wm=e}function Xm(e,t,n=1){let r=zm.createBufferSource();r.buffer=e,r.playbackRate.value=n;let i=zm.createGain();i.gain.value=t,r.connect(i).connect(Bm),r.start()}function Zm(e){let t=zm.sampleRate,n=zm.createBuffer(1,t*e,t),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=Math.random()*2-1;return n}function Qm(e,t,n,r,i){let a=zm.currentTime,o=zm.createOscillator(),s=zm.createGain();o.type=r,o.frequency.setValueAtTime(e,a),o.frequency.exponentialRampToValueAtTime(Math.max(40,t),a+n),s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(i,a+.01),s.gain.exponentialRampToValueAtTime(1e-4,a+n),o.connect(s).connect(Bm),o.start(a),o.stop(a+n+.02)}function $m(e,t,n,r){let i=zm.currentTime,a=zm.createBufferSource();a.buffer=Zm(e+.05);let o=zm.createBiquadFilter();o.type=`bandpass`,o.frequency.value=t,o.Q.value=n;let s=zm.createGain();s.gain.setValueAtTime(1e-4,i),s.gain.exponentialRampToValueAtTime(r,i+.005),s.gain.exponentialRampToValueAtTime(1e-4,i+e),a.connect(o).connect(s).connect(Bm),a.start(i),a.stop(i+e+.05)}function eh(){$u(`skate:airstart`,e=>{if(!Vm)return;let t=.5+e.chargeRatio*.5,n=.92+e.chargeRatio*.16;Xm(Vm,t,n)}),$u(`skate:landing`,()=>{Vm&&Xm(Vm,.7,.75)}),$u(`skate:bail`,()=>{Qm(380,70,.45,`sawtooth`,.22),$m(.35,900,.8,.25),setTimeout(()=>$m(.18,220,.6,.18),120)}),$u(`skate:respawn`,()=>{Qm(660,990,.18,`triangle`,.18),setTimeout(()=>Qm(990,1320,.14,`triangle`,.15),90)}),$u(`skate:finish`,()=>{if(!Um)return;let e=zm.currentTime,t=.9,n=zm.createBufferSource();n.buffer=Um;let r=zm.createGain();r.gain.setValueAtTime(t,e),r.gain.setValueAtTime(t,e+.6),r.gain.exponentialRampToValueAtTime(1e-4,e+2),n.connect(r).connect(Bm),n.start(e),n.stop(e+2+.05)}),$u(`skate:trick`,e=>{e.clean?Qm(520,1100,.16,`triangle`,.18):Qm(220,110,.22,`square`,.16)})}function th(){zm=new(window.AudioContext||window.webkitAudioContext),Bm=zm.createGain(),Bm.gain.value=.6,Bm.connect(zm.destination),Gm=zm.createGain(),Gm.gain.value=0;let e=`/skate/`;Jm(`${e}sounds/pop.mp3`).then(e=>{Vm=e}),Jm(`${e}sounds/finish.mp3`).then(e=>{Um=e}),Jm(`${e}sounds/roll.mp3`).then(e=>{Hm=e,Km&&!Wm&&Ym()}),eh(),qm()}function nh(e){if(!zm)return;let t=Q.airTime<=0,n=Math.min(1,Math.abs(Q.speed)/Zu.MAX_SPEED),r=n>.02,i=t&&!Q.bailing&&r?.4+n*.7:0,a=.75+n*.9,o=zm.currentTime;Gm&&Gm.gain.setTargetAtTime(i,o,.08),Wm&&Wm.playbackRate.setTargetAtTime(a,o,.1)}var rh=()=>matchMedia(`(pointer: coarse)`).matches||innerWidth<900;function ih(){let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e)}var ah=[`KeyW`,`KeyS`,`KeyA`,`KeyD`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`];function oh(){for(let e of ah)Xu[e]=!1}function sh(e){let t=document.createElement(`div`);t.className=`joy`;let n=document.createElement(`div`);n.className=`thumb`,t.appendChild(n),e.appendChild(t);let r=null,i=(e,t)=>{if(Math.hypot(e,t)/60<.22){oh();return}let n=e/60,r=t/60;Xu.KeyW=Xu.ArrowUp=r<-.35,Xu.KeyS=Xu.ArrowDown=r>.35,Xu.KeyA=Xu.ArrowLeft=n<-.35,Xu.KeyD=Xu.ArrowRight=n>.35},a=e=>{if(r!==e.pointerId)return;let a=t.getBoundingClientRect(),o=e.clientX-(a.left+a.width/2),s=e.clientY-(a.top+a.height/2),c=Math.hypot(o,s);c>60&&(o=o/c*60,s=s/c*60),n.style.transform=`translate(${o}px, ${s}px)`,i(o,s)},o=e=>{if(r===e.pointerId){r=null,n.style.transform=`translate(0,0)`,oh();try{t.releasePointerCapture(e.pointerId)}catch{}}};t.addEventListener(`pointerdown`,e=>{if(r===null){r=e.pointerId;try{t.setPointerCapture(e.pointerId)}catch{}a(e)}}),t.addEventListener(`pointermove`,a),t.addEventListener(`pointerup`,o),t.addEventListener(`pointercancel`,o)}var ch=[{className:`ollie`,label:`OLLIE`,code:`Space`},{className:`flipL`,label:`← FLIP`,code:`KeyY`},{className:`flipR`,label:`FLIP →`,code:`KeyI`},{className:`scoopL`,label:`← SCOOP`,code:`KeyN`},{className:`scoopR`,label:`SCOOP →`,code:`KeyM`}];function lh(e){let t=document.createElement(`div`);t.className=`pad`,e.appendChild(t);for(let e of ch){let n=document.createElement(`button`);n.className=e.className,n.textContent=e.label,t.appendChild(n);let r=!1,i=t=>{t.preventDefault(),!r&&(r=!0,n.classList.add(`pressed`),window.dispatchEvent(new KeyboardEvent(`keydown`,{code:e.code})))},a=t=>{t.preventDefault(),r&&(r=!1,n.classList.remove(`pressed`),window.dispatchEvent(new KeyboardEvent(`keyup`,{code:e.code})))};n.addEventListener(`pointerdown`,i),n.addEventListener(`pointerup`,a),n.addEventListener(`pointercancel`,a),n.addEventListener(`pointerleave`,a),n.addEventListener(`contextmenu`,e=>e.preventDefault())}}function uh(e){let t=document.createElement(`button`);t.className=`reset-btn`,t.textContent=`RESET`,e.appendChild(t);let n=!1,r=e=>{e.preventDefault(),!n&&(n=!0,t.classList.add(`pressed`),window.dispatchEvent(new KeyboardEvent(`keydown`,{code:`KeyR`})))},i=e=>{e.preventDefault(),n&&(n=!1,t.classList.remove(`pressed`),window.dispatchEvent(new KeyboardEvent(`keyup`,{code:`KeyR`})))};t.addEventListener(`pointerdown`,r),t.addEventListener(`pointerup`,i),t.addEventListener(`pointercancel`,i),t.addEventListener(`pointerleave`,i),t.addEventListener(`contextmenu`,e=>e.preventDefault())}function dh(){if(!rh())return;ih();let e=document.createElement(`div`);e.id=`mobile-controls`,document.body.appendChild(e),sh(e),lh(e),uh(e)}mu.add(Z),Yd(),Zp(),Lm(),th(),dh();var fh=performance.now();function ph(){requestAnimationFrame(ph);let e=performance.now(),t=Math.min((e-fh)/1e3,.05);fh=e,Qp(t),td(t),nd(t),Rm(t),hf(t),nh(t),wd(t),bu.render(mu,yu)}ph();